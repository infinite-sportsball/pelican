...
This proved invaluable for assembling Infinite Cincinnati timelines.

## Infinite Cincinnati Exhibition Games

OOTP has several simulation modes.
To generate alternate timelines for the Infinite Cincinnati project, we used
OOTP in Exhibition Mode, which is a way of simulating a single playoffs game,
series, or bracket.  (Infinite Cincinnati is just scratching the surface of
the different ways of dipping into the pool of infinite timelines.)

We set the roster to 17 players, to match the number of
players that were on the field during the real Game 4.
The remaining players are benched, to ensure realistic
rotations during the games (for example, not having the
Game 5 starters come into the game to pitch in relief).

![Screenshot of OOTP setup for exhibition match between 1972 World Series teams.](/img/ootp1.png)

![Screenshot of OOTP setup for Infinite Cincinnati exhibition matches.](/img/ootp2.png)

## Infinite Cincinnati Roster Setup

The rosters were set up so that only players appearing in Game 4 were on the
active roster, and the lineups were rearranged so that each player was batting
in the same lineup spot as Game 4, and playing in the correct position for Game 4.
...
We obtained the roster of players used in Game 4 of the 1972 World Series
from [baseball-reference.com (link)](https://www.baseball-reference.com/boxes/OAK/OAK197210190.shtml).

**Rosters Tab:**

Players that were in Game 4 were moved to the left side (active roster),
while players that were not in Game 4 were moved to the right side
(reserve roster).

Here is the roster from baseball-reference.com:

![Screenshot of baseball-reference.com Oakland Athletics lineup for 1972 World Series Game 4.](/img/baseballreference1.png)

Here is a screenshot of the Oakland Athletics roster with Game 4 players active:

![Screenshot of OOTP roster for 1972 Oakland Athletics in World Series Game 4.](/img/ootp3.png)
...
The starting pitchers are set (Ken Holtzman for the Athletics, Don Gullett for the Reds),
...
Here is a screenshot of the completed batting lineup for the Oakland Athletics:

![Screenshot of OOTP lineup for 1972 Oakland Athletics in World Series Game 4.](/img/ootp4.png)
...
Clicking "Return to OOTP Main Screen" without clicking either "Play" or "Simulate" will
...
Once the clean, unsimulated version of the Game 4 matchup has been saved, locate
...
and generate a new Infinite Cincinnati timeline.
