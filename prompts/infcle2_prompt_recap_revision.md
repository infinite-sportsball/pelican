...
- Endings that fail to deliver the emotional verdict. The final sentence must make the reader feel who won and what it meant. This is the single most important sentence in the piece — not a place for wry summations, combined stat lines, atmospheric scene-setting, or clever observations about the nature of the game. The last sentence is the emotional detonator, not a denouement.
  - **If Cleveland wins**: Fifty years of drought just ended. The final sentence must land like a championship-winning moment — the roar, the release, the unburdening. Do not end on people filing out, standing in the cold, the stadium emptying, a pitching line, or any image that reads like quiet contemplation. A World Series win is not quiet. Name the joy. Name the noise. Name what just broke open after fifty years.
  - **If San Diego wins**: Forty-five thousand people just watched the door close again, one year after the Game 7 loss to Florida. The final sentence must carry that specific, accumulated weight — not a generic "it wasn't enough" or "the wait would continue" but something that names who failed, who succeeded on the other side, and connects this loss to the particular grief of a city that keeps reaching the threshold.
  - **In both cases**: The final sentence should be concrete and particular to THIS game — name a player, name what they did, name what the crowd felt. Never end on an abstraction, a metaphor about baseball, a wry aside about the stat line, or a scene of people leaving. The reader's last impression must be the emotional truth of the outcome, not a writerly observation about it.
  ...
  - **CRITICAL — get the post-game body language right for winners vs. losers.** Winning players do NOT sit in the dugout, jam their hands in their pockets, lean on the rail, or look contemplatively out at the field when their team wins the World Series. They lose their fucking minds. They sprint out of the dugout, they pile on the mound, they mob each other in the middle of the field, they jump on each other's backs. The cold doesn't exist anymore; the weather doesn't exist anymore; nothing exists except the eruption. A winning closer holds the ball aloft and gets buried by his catcher, a first baseman making the final out thoughtfully stuffs the game ball in his back pocket before joining the dogpile in the center of the field. A winning starter charges out of the dugout at a full sprint with both arms up. The Player of the Game does not "allow himself" anything — he is past control. Quiet stillness at the moment of victory is a sentimental cliché that contradicts what actually happens when a fifty-year drought ends. LOSING players are the ones who sit in the dugout with their hands jammed in their pockets, watching the celebration from across the field, contemplating the long road back. Losing players go still. Losing players stare. Never assign losing-team body language to winning-team players, or vice versa — it inverts the emotional truth of the moment.
