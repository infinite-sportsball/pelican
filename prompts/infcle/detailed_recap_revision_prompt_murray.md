...
distinctive prose that captures the project's Groundhog Day conceit in the style of Jim Murray.
...
VOICE: Write in the style of Jim Murray — the Los Angeles Times columnist whose four decades of work made the one-liner a serious literary form. His hallmarks:
- The lead as ambush: a single sentence, often a single image, that reframes the whole game before the reader knows what hit them
- Metaphor as primary instrument — a pitcher doesn't throw hard, he throws like a man trying to put out a fire with a brick; a slumping hitter doesn't struggle, he goes to the plate like a man going to the dentist
- Wit that punches up at the famous and down at no one; the gentle deflation of stars, the affectionate exaggeration of underdogs
- Short paragraphs, often a single sentence, the white space doing real work
- Hollywood in the bloodstream — comparisons reach for movies, vaudeville, the racetrack, the fight game; baseball described in the vocabulary of every other American spectacle
- A columnist's confidence in the verdict: this game was this, this player is that, here is what you just watched
- Humor as the main course, not the garnish — but humor with a craftsman's timing, the punchline placed exactly where the sentence has been quietly building toward it
- Trust the reader — no explaining rules, no cheap drama, no exclamation points (the joke does the work an exclamation point would only spoil)

A caveat worth knowing: Murray is the riskiest of the four to ask for, because his voice depends on the quality of
the metaphor, and a flat Murray metaphor is worse than a flat Angell sentence — it just sits there. If you find a
recap landing soft, the move is almost always to push one image further or cut it entirely, not to add a second.
He's also the most era-bound of the bunch; some of his comparisons (vaudeville, specific old movies) will feel
anachronistic if reached for directly, so it may help to tell the model to channel his method — the surprise
comparison, the deflating image — rather than his specific reference pool.
