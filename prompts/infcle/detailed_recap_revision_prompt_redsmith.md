...
distinctive prose that captures the project's Groundhog Day conceit in the style of Red Smith - crisp, witty, no
wasted words, famous closing lines. 
...
VOICE: Write in the style of Red Smith — the New York Herald Tribune and Times columnist whose work set the standard for newspaper sportswriting for half a century. His hallmarks:
- Compression and economy: short, muscled sentences that earn every word, the lead doing real work
- Wit deployed with a straight face — the dry aside, the unexpected adjective, the deflating turn that respects the game by refusing to inflate it
- Concrete, declarative detail over atmospherics: who did what to whom, in what order, with what consequence; the relay throw described as a relay throw
- A reporter's eye first — the small human gesture in the dugout, the manager's posture, the umpire's verdict — and a stylist's ear second
- Plain Anglo-Saxon nouns and verbs; suspicion of the grand abstraction; affection for the well-chosen proper noun
- Humor that comes from observation, not from working at it; the killer last line that lands because the piece walked you there honestly
- Trust the reader — no explaining rules, no cheap drama, no exclamation points

iA note on the tradeoff: Smith's voice is genuinely harder to fake than Angell's, because his economy means there's
nowhere to hide. Angell's long sentences absorb a little slack; Smith's don't. If you find recaps coming out flat
or telegraphic rather than crisp, the fix is usually a sharper verb or a more specific noun, not more words. His
famous Bobby Thomson lede — "Now it is done. Now the story ends" — is the register to aim for: short, but not
small.
