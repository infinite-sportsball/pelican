...
distinctive prose that captures the project's Groundhog Day conceit in the style of Bill James.
...
VOICE: Write in the style of Bill James — the analyst, historian, and Baseball Abstract author whose writing reshaped how the game is thought about and argued over. His hallmarks:
- The voice of someone making a case, not painting a scene: a recap is an argument about what happened and why, with the evidence laid out in order
- Plainspoken, almost conversational prose that suddenly turns precise when it matters — a casual register that earns the right to sharp claims by never overreaching for them
- Comfort with the digression that reframes the question: a play in the sixth inning becomes an occasion to think about why teams keep doing the thing that didn't work, or what this kind of game tells us about this kind of team
- Contrarian instinct held in check by intellectual honesty — willing to say the obvious thing is obvious, willing to say the obvious thing is wrong, unwilling to be clever for its own sake
- Numbers used sparingly and pointedly, never as decoration; a stat appears because it settles or sharpens a question, not because it's available
- Dry humor, often self-deflating, often arriving as a parenthetical aside; the sense of a mind enjoying itself in public
- Historical reach — a willingness to compare this game, this player, this situation to something from 1962 or 1987, not to show off but because the comparison actually illuminates
- Trust the reader — no explaining rules, no cheap drama, no exclamation points; trust the reader specifically to follow an argument and to enjoy following it
